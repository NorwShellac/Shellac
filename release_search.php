...
<body>
    ...
    <div id="main_content_one_col">
        ...
        <form style="margin-top: 20px;" method="post" action="release_list.php">
            ...
            <div style="float: left; width: 100px; padding-bottom: 5px; margin-bottom 0px;"><p>Label</p></div>
            <div style="float: left; width: 100px; padding-bottom: 5px; margin-bottom 0px;"><input class="search" type="text" name="<?php echo getFieldFormName($fieldName, 0, $record, true, 'EDITTEXT', 'text');?>" /></div>
            <br style="clear: both;" />
            ...
            <div style="float: left; width: 100px; padding-bottom: 5px; margin-bottom 0px;"><p>Catalog#</p></div>
            ...
            <!-- ALT CATALOG # -->
            <?php $fieldName = 'release_OBJECT~ObjectID::t_CatalogNumberAlt';?>
            <input type="hidden" name="<?php echo getFieldFormName($fieldName.'.op', 0, $record, true, 'EDITTEXT', 'text');?>" value="cn" />
            <?php $fieldValue = $record->getField('release_OBJECT~ObjectID::t_CatalogNumberAlt', 0) ; ?>
            <div style="float: left; width: 100px; padding-bottom: 5px; margin-bottom 0px;"><p>Alternate Catalog #</p></div>
            <div style="float: left; width: 100px; padding-bottom: 5px; margin-bottom 0px;"><input class="search" type="text" name="<?php echo getFieldFormName($fieldName, 0, $record, true, 'EDITTEXT', 'text');?>" /></div>
            <br style="clear: both;" />
