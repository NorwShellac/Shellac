...
<body style="background-image: none;">
    ...
    <div id="main_content_one_col">
        ...
        <form style="margin-top: 20px;" method="post" action="artist_list.php" target="_parent">
            ...
            <!-- ARTIST -->
            <?php $fieldName = 'artistweb_ARTIST~ArtistID::x_ArtistName';?>
            <input type="hidden" name="<?php echo getFieldFormName($fieldName.'.op', 0, $record, true, 'EDITTEXT', 'text');?>" value="cn" />
            <?php $fieldValue = $record->getField('artistweb_ARTIST~ArtistID::x_ArtistName', 0) ; ?>
            ...
            <!-- Title -->
            <?php $fieldName = 'artistweb_ARTIST~ArtistID::x_MusicTitle';?>
            <input type="hidden" name="<?php echo getFieldFormName($fieldName.'.op', 0, $record, true, 'EDITTEXT', 'text');?>" value="cn" />
            <?php $fieldValue = $record->getField('artistweb_ARTIST~ArtistID::x_MusicTitle', 0) ; ?>
